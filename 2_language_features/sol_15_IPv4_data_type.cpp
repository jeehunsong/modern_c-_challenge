...
/*
    1. constexpr constructors
        - Possible to evaluate the value at compile time
    2. explicit constructor
        - This constructor is not implicit
    3. noexcept on copy constructor and equal operator
        - Material to read: https://stackoverflow.com/questions/16244313/does-adding-noexceptfalse-benefit-the-code-in-any-way
        - Why is there no noexcept on first three constructor?
    4. to_string method
    5. is.setstate(std::ios_base::failbit) when input fails
*/
